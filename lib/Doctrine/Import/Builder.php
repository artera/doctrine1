...
class Doctrine_Import_Builder
{
    ...
    public function buildAttributes(array $attributes): string
    {
        ...
        foreach ($attributes as $key => $value) {
            ...
            $build .= '$this->setAttribute(Doctrine_Core::ATTR_' . strtoupper($key) . ", $values);\n";
        }
    ...
    public function writeDefinition(array $definition): void
    {
        ...
        if (!empty($definition['connection'])) {
            ...
            $code .= "Doctrine_Manager::getInstance()->bindComponent({$this->varExport($definition['connectionClassName'])}, {$this->varExport($definition['connection'])});\n";
        }
