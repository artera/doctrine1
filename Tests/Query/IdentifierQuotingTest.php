...
class IdentifierQuotingTest extends DoctrineUnitTestCase
{
    ...
    public function testQuerySupportsIdentifierQuoting()
    {
        ...
        $this->assertEquals($q->getSqlQuery(), 'SELECT "e"."id" AS "e__id", MAX("e"."id") AS "e__0", MIN("e"."name") AS "e__1" FROM "entity" "e" WHERE ("e"."type" = 0)');
    ...
    public function testQuerySupportsIdentifierQuotingInWherePart()
    {
        ...
        $this->assertEquals($q->getSqlQuery(), 'SELECT "e"."id" AS "e__id", "e"."name" AS "e__name" FROM "entity" "e" WHERE ("e"."id" = 3 AND ("e"."type" = 0))');
    ...
    public function testQuerySupportsIdentifierQuotingWorksWithinFunctions()
    {
        ...
        $this->assertEquals($q->getSqlQuery(), 'SELECT "e"."id" AS "e__id", "e"."name" AS "e__name" FROM "entity" "e" WHERE TRIM(u.name) = 3 AND ("e"."type" = 0)');
    }
    */
    ...
    public function testQuerySupportsIdentifierQuotingWithJoins()
    {
        ...
        $this->assertEquals($q->getSqlQuery(), 'SELECT "e"."id" AS "e__id", "e"."name" AS "e__name" FROM "entity" "e" LEFT JOIN "phonenumber" "p" ON "e"."id" = "p"."entity_id" WHERE ("e"."type" = 0)');
    }
    ...
    public function testLimitSubqueryAlgorithmSupportsIdentifierQuoting()
    {
        ...
        $this->assertEquals($q->getSqlQuery(), 'SELECT "e"."id" AS "e__id", "e"."name" AS "e__name" FROM "entity" "e" INNER JOIN "phonenumber" "p" ON "e"."id" = "p"."entity_id" WHERE "e"."id" IN (SELECT DISTINCT "e2"."id" FROM "entity" "e2" INNER JOIN "phonenumber" "p2" ON "e2"."id" = "p2"."entity_id" WHERE ("e2"."type" = 0) LIMIT 5) AND ("e"."type" = 0)');
    }
    ...
    public function testCountQuerySupportsIdentifierQuoting()
    {
        ...
        $this->assertEquals($q->getCountSqlQuery(), 'SELECT COUNT(*) AS "num_results" FROM (SELECT "e"."id" FROM "entity" "e" INNER JOIN "phonenumber" "p" ON "e"."id" = "p"."entity_id" WHERE ("e"."type" = 0) GROUP BY "e"."id") "dctrn_count_query"');
    }
    ...
    public function testUpdateQuerySupportsIdentifierQuoting()
    {
        ...
        $this->assertEquals($q->getSqlQuery(), 'UPDATE "entity" SET "name" = ? WHERE ("id" = ? AND ("type" = 0))');
    }
    ...
    public function testUpdateQuerySupportsIdentifierQuoting3()
    {
        ...
        $this->assertEquals($q->getSqlQuery(), 'UPDATE "entity" SET "name" = LOWERCASE("name") WHERE ("id" = ? AND ("type" = 0))');
    }
    ...
    public function testUpdateQuerySupportsIdentifierQuoting5()
    {
        ...
        $this->assertEquals($q->getSqlQuery(), 'UPDATE "entity" SET "name" = UPPERCASE(LOWERCASE("name")) WHERE ("id" = ? AND ("type" = 0))');
    }
    ...
    public function testUpdateQuerySupportsIdentifierQuoting6()
    {
        ...
        $this->assertEquals($q->getSqlQuery(), 'UPDATE "entity" SET "name" = UPPERCASE(LOWERCASE("id")) WHERE ("id" = ? AND ("type" = 0))');
    }
    ...
    public function testUpdateQuerySupportsIdentifierQuoting7()
    {
        ...
        $this->assertEquals($q->getSqlQuery(), 'UPDATE "entity" SET "name" = CURRENT_TIMESTAMP WHERE ("id" = ? AND ("type" = 0))');
    }
    ...
    public function testUpdateQuerySupportsIdentifierQuoting8()
    {
        ...
        $this->assertEquals($q->getSqlQuery(), 'UPDATE "entity" SET "id" = "id" + 1 WHERE ("name" = ? AND ("type" = 0))');
