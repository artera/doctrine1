...
class MysqlTest extends DoctrineUnitTestCase
{
    ...
    {
        static::$exc = new \Doctrine_Connection_Mysql_Exception();
    ...
    public function testNotLockedErrorIsSupported()
    {
        ...
        $this->assertEquals(static::$exc->getPortableCode(), \Doctrine_Core::ERR_NOT_LOCKED);
    }
    ...
    public function testNoSuchDbErrorIsSupported()
    {
        ...
        $this->assertEquals(static::$exc->getPortableCode(), \Doctrine_Core::ERR_NOSUCHDB);
    }
    ...
    public function testNoDbSelectedErrorIsSupported()
    {
        ...
        $this->assertEquals(static::$exc->getPortableCode(), \Doctrine_Core::ERR_NODBSELECTED);
    }

    public function testAccessViolationErrorIsSupported()
    {
        $this->assertTrue(static::$exc->processErrorInfo([0, 1142, '']));
        $this->assertEquals(static::$exc->getPortableCode(), \Doctrine_Core::ERR_ACCESS_VIOLATION);
    }
    ...
    public function testCannotDropErrorIsSupported()
    {
        ...
        $this->assertEquals(static::$exc->getPortableCode(), \Doctrine_Core::ERR_CANNOT_DROP);
    }

    public function testCannotCreateErrorIsSupported()
    {
        $this->assertTrue(static::$exc->processErrorInfo([0, 1004, '']));
        $this->assertEquals(static::$exc->getPortableCode(), \Doctrine_Core::ERR_CANNOT_CREATE);
    }
    ...
    public function testAlreadyExistsErrorIsSupported()
    {
        ...
        $this->assertEquals(static::$exc->getPortableCode(), \Doctrine_Core::ERR_ALREADY_EXISTS);
    }
