...
class PgsqlTest extends DoctrineUnitTestCase
{
    ...
    {
        static::$exc = new \Doctrine_Connection_Pgsql_Exception();
    ...
    public function testInvalidNumberErrorIsSupported()
    {
        ...
        $this->assertEquals(static::$exc->getPortableCode(), \Doctrine_Core::ERR_INVALID_NUMBER);
    }
    ...
    public function testInvalidErrorIsSupported()
    {
        ...
        $this->assertEquals(static::$exc->getPortableCode(), \Doctrine_Core::ERR_INVALID);
    }
    ...
    public function testDivZeroErrorIsSupported()
    {
        ...
        $this->assertEquals(static::$exc->getPortableCode(), \Doctrine_Core::ERR_DIVZERO);
    }
