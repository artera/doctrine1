...
class Ticket1211Test extends DoctrineUnitTestCase
{
    ...
    {
        $orig = static::$conn->getAttribute(\Doctrine_Core::ATTR_PORTABILITY);
        static::$conn->setAttribute(\Doctrine_Core::ATTR_PORTABILITY, \Doctrine_Core::PORTABILITY_NONE);
        ...
        static::$conn->setAttribute(\Doctrine_Core::ATTR_PORTABILITY, $orig);
    }
}
