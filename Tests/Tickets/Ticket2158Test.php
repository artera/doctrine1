...
namespace Tests\Tickets {
    ...
    class Ticket2158Test extends DoctrineUnitTestCase
    {
        ...
        {
            $q = \Doctrine1\Core::getTable('T2158_Model2')->createQuery('m2')->leftJoin('m2.Relation m1 ON m2.id    = m1.m2_id');
...
namespace {
    class T2158_Model1 extends \Doctrine1\Record
    {
    ...
    class T2158_Model2 extends \Doctrine1\Record
    {
        public function setTableDefinition(): void
        {
        }
