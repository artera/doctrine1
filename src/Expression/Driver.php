 ...
 */
class Driver extends \Doctrine1\Connection\Module
{
    /**
    ...
    {
        throw new \Doctrine1\Expression\Exception('Regular expression operator is not supported by this database driver.');
    }
    ...
    {
        throw new \Doctrine1\Expression\Exception('SQL soundex function not supported by this driver.');
    }
    ...
    public function in($column, $values)
    {
        ...
        if (count($values) == 0) {
            throw new \Doctrine1\Expression\Exception('Values array for IN operator should not be empty.');
        }
    ...
    {
        throw new \Doctrine1\Expression\Exception('method not implemented');
    }
