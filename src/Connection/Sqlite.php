...
class Sqlite extends \Doctrine1\Connection
{
    ...
    public function createDatabase(): void
    {
        if (!$dsn = $this->getOption('dsn')) {
            throw new \Doctrine1\Connection\Exception('You must create your \Doctrine1\Connection by using a valid Doctrine style dsn in order to use the create/drop database functionality');
        }
